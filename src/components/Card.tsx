        ...
        {liveUrl && (
          <div className="mt-auto">
            <a 
              ...
              aria-label={`${title} - პროექტის ნახვა ლაივში`}
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-medium py-3 rounded-xl flex items-center justify-center transition-colors duration-300"
            >
              ნახე ლაივში
            </a>
          </div>
